...
class fd extends JFrame implements ItemListener, ActionListener{  
...
for(i=0;i<=7;i++){  
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();  
    ...
    JOptionPane.showMessageDialog(fd.this,"!!!YOU won!!! click reset");     
         break;  
                   }  
             else if(icon1==ic2){   
             ...
             b[(a[i][3]-1)].setIcon(ic22);   
               JOptionPane.showMessageDialog(fd.this,"won! click reset");  
                break;             
               }  
         }  
    }    
