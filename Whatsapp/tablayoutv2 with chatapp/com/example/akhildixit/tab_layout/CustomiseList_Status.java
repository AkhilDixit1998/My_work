...
public class CustomiseList_Status extends BaseAdapter{
    ...
    CustomiseList_Status(Context context, Integer images[], String data[],String time[])
    {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        view=inflater.inflate(R.layout.customliststatus,null);

        TextView name=(TextView)view.findViewById(R.id.status_name_textview);
        TextView data=(TextView)view.findViewById(R.id.status_time_textview);
         imageView=(ImageView)view.findViewById(R.id.status_imageview);
